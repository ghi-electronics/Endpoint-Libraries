...
namespace GHIElectronics.Endpoint.UI.Media {
    ...
    internal class MediaContext : DispatcherObject, IDisposable {
        ...
        internal MediaContext() {
            ...
            //else 
            this._screen = new Bitmap(Graphics.FromImage(new GHIElectronics.Endpoint.Drawing.Bitmap(WindowManager.Instance.Width, WindowManager.Instance.Height)));

            this._screenW = (int)WindowManager.Instance.Width;
            this._screenH = (int)WindowManager.Instance.Height;
            this._dirtyX0 = (int)WindowManager.Instance.Width;
            this._dirtyY0 = (int)WindowManager.Instance.Height;
        }
