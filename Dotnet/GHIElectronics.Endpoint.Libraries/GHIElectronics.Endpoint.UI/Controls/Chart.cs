...
namespace GHIElectronics.Endpoint.UI.Controls {
    public class Chart : Image, IDisposable {
        ...
        public GHIElectronics.Endpoint.Drawing.Pen AxisPen { get; set; } = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Black, 1);
        public GHIElectronics.Endpoint.Drawing.Pen ChartPen { get; set; } = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Green, 1);
        public int RadiusPoint { get; set; } = 10;
        public GHIElectronics.Endpoint.Drawing.Brush EllipseColor { get; set; } = new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.Black);
        public GHIElectronics.Endpoint.Drawing.Brush DivisionColor { get; set; } = new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.Black);
        public GHIElectronics.Endpoint.Drawing.Brush TextColor { get; set; } = new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.Black);
        public GHIElectronics.Endpoint.Drawing.Brush BackgroundColor { get; set; } = new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.White);
        ...
        private GHIElectronics.Endpoint.Drawing.Bitmap GetChart() => this.Mode switch {
        ...
        private GHIElectronics.Endpoint.Drawing.Bitmap GetLineChart() {
            var bitmap = new GHIElectronics.Endpoint.Drawing.Bitmap(this.Width, this.Height);
        ...
        private GHIElectronics.Endpoint.Drawing.Bitmap GetRectangleChart() {
            var bitmap = new GHIElectronics.Endpoint.Drawing.Bitmap(this.Width, this.Height);
            ...
            for (var i = 0; i < this.Items.Count; i++) {
                ...
                graph.DrawLine(new GHIElectronics.Endpoint.Drawing.Pen(this.BackgroundColor, BorderWidth), commonX,
                    this.pStart.Y - BorderWidth, commonX, this.pStart.Y - (int)pixelYValue);
                graph.DrawLine(new GHIElectronics.Endpoint.Drawing.Pen(this.BackgroundColor, BorderWidth), commonX,
                    this.pStart.Y - (int)pixelYValue, commonX + divisionWidth,
                    this.pStart.Y - (int)pixelYValue);
                graph.DrawLine(new GHIElectronics.Endpoint.Drawing.Pen(this.BackgroundColor, BorderWidth),
