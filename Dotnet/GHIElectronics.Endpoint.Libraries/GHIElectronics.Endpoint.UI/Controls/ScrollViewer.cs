...
namespace GHIElectronics.Endpoint.UI.Controls {
    public class ScrollViewer : ContentControl {
        ...
        protected override void OnButtonDown(GHIElectronics.Endpoint.UI.Input.ButtonEventArgs e) {
            switch (e.Button) {
                case HardwareButton.Up:
                    if (this._scrollingStyle == ScrollingStyle.LineByLine) this.LineUp(); else this.PageUp();
                    break;
                case HardwareButton.Down:
                    if (this._scrollingStyle == ScrollingStyle.LineByLine) this.LineDown(); else this.PageDown();
                    break;
                case HardwareButton.Left:
                    if (this._scrollingStyle == ScrollingStyle.LineByLine) this.LineLeft(); else this.PageLeft();
                    break;
                case HardwareButton.Right:
                    if (this._scrollingStyle == ScrollingStyle.LineByLine) this.LineRight(); else this.PageRight();
                    break;
                default:
                    return;
            }
