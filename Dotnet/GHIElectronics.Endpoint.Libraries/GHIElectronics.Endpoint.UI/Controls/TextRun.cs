...
namespace GHIElectronics.Endpoint.UI.Controls {
    public class TextRun {
        ...
        public readonly GHIElectronics.Endpoint.Drawing.Font Font;
        ...
        public TextRun(string text, GHIElectronics.Endpoint.Drawing.Font font, Color foreColor) {
            ...
            while (!foundBreak) {
                ...
                if (foundBreak) {
                    if (leftBreak >= 0) {
                        ...
                        leftBreak = this.EmergencyBreak(availableWidth);
