...
namespace GHIElectronics.Endpoint.UI.Controls {
    public class Gauge : Image, IDisposable {
        ...
        private GHIElectronics.Endpoint.Drawing.Color foreColor = GHIElectronics.Endpoint.Drawing.Color.FromArgb(255, 0, 0, 0);
        private GHIElectronics.Endpoint.Drawing.Color dialColor = GHIElectronics.Endpoint.Drawing.Color.FromArgb(255, 230, 230, 250);
        ...
        private GHIElectronics.Endpoint.Drawing.Image backgroundImg;
        private Rectangle rectImg;
        GHIElectronics.Endpoint.Drawing.Bitmap bmp;
        ...
        private GHIElectronics.Endpoint.Drawing.Color backColor = GHIElectronics.Endpoint.Drawing.Color.FromArgb(255, 255, 255, 255);
        public Color BackColor {
            get => Color.FromArgb(this.backColor.A, this.backColor.R, this.backColor.G, this.backColor.B);
            set => this.backColor = GHIElectronics.Endpoint.Drawing.Color.FromArgb(value.A, value.R, value.G, value.B);
        }
        ...
        public Color DialColor {
            ...
            set {
                this.dialColor = GHIElectronics.Endpoint.Drawing.Color.FromArgb(value.A, value.R, value.G, value.B);
                this.requiresRedraw = true;
        ...
        /// </summary>
        /// <param name="e"></param>
        private GHIElectronics.Endpoint.Drawing.Bitmap GetGauge() {
        ...
        protected void PaintBackground(Graphics gfx) {
            ...
            this.backgroundImg ??= new GHIElectronics.Endpoint.Drawing.Bitmap(this.Width, this.Height);
            ...
            if (this.requiresRedraw) {
                ...
                //g.SmoothingMode = GHIElectronics.Endpoint.Drawing.Drawing2D.SmoothingMode.HighQuality;
                this.width = this.Width - this.x * 2;
                this.height = this.Height - this.y * 2;
                ...
                //Draw Rim
                var outlineBrush = new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.FromArgb(112, 128, 144));//gray
                var outline = new GHIElectronics.Endpoint.Drawing.Pen(outlineBrush, (float)(this.width * .03));
                //g.DrawEllipse(outline, this.rectImg.X, this.rectImg.Y, this.rectImg.Width, this.rectImg.Height);
                var darkRim = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.FromArgb(112, 128, 144));//gray
                ...
                if (this.EnableThresold) {
                    //Draw Colored Rim
                    var colorPen = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.FromArgb(220, 220, 220), this.Width / 40);//new Pen(Color.FromArgb(190, Color.FromArgb(220, 220, 220)), this.Width / 40);
                                                                                                                         //var blackPen = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Black, this.Width / 200);//new Pen(Color.FromArgb(250, Color.Black), this.Width / 200);
                    ...
                    //Draw Threshold
                    colorPen = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.FromArgb(124, 252, 0), this.Width / 50);
                ...
                if (this.EnableDigitalNumber) {
                    ...
                    g.FillRectangle(new SolidBrush(GHIElectronics.Endpoint.Drawing.Color.Gray), digiRect.X, digiRect.Y, digiRect.Width, digiRect.Height);
        ...
        void DrawArc(Graphics g, GHIElectronics.Endpoint.Drawing.Pen pen, Rectangle rect, double startAngle, double sweepAngle) {
            int ax, ay;
        ...
        private void DrawPointer(Graphics g, int cx, int cy) {
            ...
            var pointer = new GHIElectronics.Endpoint.Drawing.SolidBrush(GHIElectronics.Endpoint.Drawing.Color.Black);
            ...
            var gpointer = new GHIElectronics.Endpoint.Drawing.SolidBrush(GHIElectronics.Endpoint.Drawing.Color.FromArgb(112, 128, 144)); //(shinePts[0], shinePts[2], Color.SlateGray, Color.Black);
        ...
        void FillPolygon(Graphics g, GHIElectronics.Endpoint.Drawing.Brush brush, PointF[] points) {
            if (points.Length <= 1) return;
            var pen = new GHIElectronics.Endpoint.Drawing.Pen(brush);
        ...
        private void DrawGloss(Graphics g) {
            ...
            var gradientBrush = new GHIElectronics.Endpoint.Drawing.SolidBrush(GHIElectronics.Endpoint.Drawing.Color.White);
            /*
        ...
        private void DrawCenterPoint(Graphics g, Rectangle rect, int cX, int cY) {
            ...
            brush = new GHIElectronics.Endpoint.Drawing.SolidBrush(GHIElectronics.Endpoint.Drawing.Color.FromArgb(112, 128, 144));//new LinearGradientBrush(rect, Color.SlateGray, Color.Black, LinearGradientMode.ForwardDiagonal);
            g.FillEllipse(brush, (int)rectangle.X, (int)rectangle.Y, (int)rectangle.Width, (int)rectangle.Height);
        }
        ...
        private void DrawCalibration(Graphics g, Rectangle rect, int cX, int cY) {
            ...
            var thickPen = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Black, this.Width / 50);
            var thinPen = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Black, this.Width / 100);
            ...
            for (var i = 0; i <= noOfParts; i++) {
                ...
                var stringPen = new GHIElectronics.Endpoint.Drawing.SolidBrush(this.foreColor);
        ...
        private void DrawDigit(Graphics g, int number, PointF position, bool dp, float height) {
            ...
            var outline = new GHIElectronics.Endpoint.Drawing.Pen(GHIElectronics.Endpoint.Drawing.Color.Black);//new Pen(Color.FromArgb(40, this.dialColor));
            var fillPen = new GHIElectronics.Endpoint.Drawing.Pen(this.dialColor);
        ...
        private void Resize() {
            ...
            this.bmp = new GHIElectronics.Endpoint.Drawing.Bitmap(this.Width, this.Height);
