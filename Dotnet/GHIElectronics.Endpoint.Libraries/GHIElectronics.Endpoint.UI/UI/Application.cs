...
*/
    ...
    public class Application : DispatcherObject {
        ...
        private void Initialize() {
            ...
            WindowManager.EnsureInstance(this.Width, this.Height);

            _stylusMaxX = (int)this.Width;
            _stylusMaxY = (int)this.Height;
...
*/
            ...
            if (ev is TouchEvent touchEvent) {
                ...
                if (targetWindow != null && touchEvent.EventMessage == (byte)TouchMessages.Down) {
                    ...
                    if (!(x <= xSrc && xSrc <= (x + w) &&
                        ...
                        if (xSrc <= (int)this.Width &&
                           ySrc <= (int)this.Height) {
                            targetWindow = null;
                        }
                    }
                }
        ...
        public event EventHandler Startup {
            add { this.VerifyAccess(); this._startupEventHandler += value; }
            remove { this.VerifyAccess(); this._startupEventHandler -= value; }
        }
        ...
        public event EventHandler Exit {
            add { this.VerifyAccess(); this._exitEventHandler += value; }
            remove { this.VerifyAccess(); this._exitEventHandler -= value; }
        }
