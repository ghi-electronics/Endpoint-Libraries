using GHIElectronics.Endpoint.Drawing.Imaging;
using System.IO;
...
namespace GHIElectronics.Endpoint.Drawing
{
    ...
    {
        internal Graphics imgGfx;
        private bool disposed;

        public int Width => this.imgGfx.Width;
        public int Height => this.imgGfx.Height;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!this.disposed)
            {
                ...
                this.imgGfx.callFromImage = false;
        ...
        public virtual void SetPixel(int x, int y, Color color) => this.imgGfx.SetPixel(x, y, color);
        public virtual Color GetPixel(int x, int y) => Color.FromArgb((int)this.imgGfx.GetPixel(x, y));
        public byte[] GetBitmap() => this.imgGfx.GetBitmap();
        public byte[] GetBitmap(int x, int y, int width, int height) => this.imgGfx.GetBitmap(x, y, width, height);
        public void MakeTransparent(Color color) => this.imgGfx.MakeTransparent(color);
    ...
    {
        //private Bitmap(Internal.Bitmap bmp) => this.data = new Graphics(bmp);
        public Bitmap(int width, int height) => this.imgGfx = new Graphics(width, height);
        public Bitmap(byte[] data, int width, int height) => this.imgGfx = new Graphics(data, width, height);
        ...
        public Bitmap(byte[] buffer) {
            ...
            this.imgGfx = new Graphics(buffer);
        }
        ...
        public override void SetPixel(int x, int y, Color color) => this.imgGfx.SetPixel(x, y, color);
        public override Color GetPixel(int x, int y) => Color.FromArgb((int)this.imgGfx.GetPixel(x, y));
    }
