...
namespace GHIElectronics.Endpoint.UI.Threading {
    ...
    public sealed class DispatcherOperation {
        ...
        /// </returns>
        public DispatcherOperationStatus Wait() => this.Wait(new TimeSpan(-TimeSpan.TicksPerMillisecond)); /// Negative one (-1) milliseconds to prevent the timer from starting. See documentation.
        ...
        private class DispatcherOperationFrame : DispatcherFrame, IDisposable {
            ...
            private void OnCompletedOrAborted(object sender, EventArgs e) => this.Exit();

            private void OnTimeout(object arg) => this.Exit();
