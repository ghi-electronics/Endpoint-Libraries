...
namespace GHIElectronics.Endpoint.Devices.UsbHost
{
    ...
    //    public string IdStr => this.idStr;
    ...
    //    static void GetDeviceInformation(uint id, out ushort vendor, out ushort product, out byte port) {
    //        id = 0;
    //        vendor = 0;
    //        product = 0;
    //        port = 0;
    ...
    public class BaseDevice   { 
        ...
        public BaseDevice(int id, string name, DeviceType type) {
